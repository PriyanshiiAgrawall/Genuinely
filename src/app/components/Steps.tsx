...
const steps = [
    {
        name: 'Create',
        description: 'Design a custom testimonial form tailored to your project needs.',
        icon: Pencil,
    },
    {
        name: 'Share',
        description: `Send your project's unique form link to your clients/users.`,
        icon: Share2,
    },
    {
        name: 'Collect',
        description: 'Receive and review client/users testimonials in your dashboard.',
        icon: Inbox,
    },
    {
        name: 'Showcase',
        ...
        <section id="how-it-works" className="py-20 bg-gray-800">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="lg:text-center">
                    <h2 className="text-base text-primary font-semibold tracking-wide uppercase text-[#dbb04c]">How It Works</h2>
